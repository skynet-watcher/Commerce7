...
**Source:** https://developer.commerce7.com/docs/wine-varietals
...
Below is a sample response, but we are continually adding new varietals to the system. Please check to see if your varietal exists in Commerce7's standard list. If it doesn't, reach out to [[email protected]](/cdn-cgi/l/email-protection#13606663637c616753707c7e7e76617076243d707c7e).
* * *
# 
List varietals
**`GET`** `/wine-varietal`
