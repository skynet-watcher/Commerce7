...
**Source:** https://developer.commerce7.com/docs/client-settings
...
If you're looking for how to collect data from the client's Commerce7 account, go to [Configure your App Version](/docs/configure-your-app-version).
