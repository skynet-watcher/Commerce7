...
**Source:** https://developer.commerce7.com/docs/creating-an-app

---

1. Getting started is pretty simple, log into the [App Development Center](https://dev-center.platform.commerce7.com/) or you can log in to [Commerce7](https://admin.platform.commerce7.com/) and go to Developers > App Dev Center. (Don't have an account yet? Learn more [here](/docs/commerce7-developer-docs).)
...
Here's a quick rundown of what some of the next steps for building your app can look like.
  ...
  * Configure your app's [APIs & Webhooks](/docs/app-apis-webhooks) for everything you will need permission to access or listen to in a client's account
  * Display your app in Commerce7 through [App Extensions](/docs/app-extensions) and build and style pages quickly using our [UI Component Library](/docs/ui-component-library)
  * Verify requests taking place through your app with [Authenticate App Requests](/docs/authenticate-app)
  * Add fields for clients to complete on installation through [Client Settings](/docs/client-settings)


**Think you 're ready to publish?** [Read here](/docs/pricing) for the final steps
