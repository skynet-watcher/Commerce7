...
**Source:** https://developer.commerce7.com/docs/authenticate-app
...
> This is only needed if your app is using an [App Extension](/docs/app-extensions). Learn more about standard authentication for API requests [here](/docs/commerce7-apis).
### 
