...
**Source:** https://developer.commerce7.com/docs/announcements
...
**Steps to take**
  ...
  4. **Select API endpoints required** : In your app version, select which API endpoints you need access to. When the client installs the app, it will grant you this access. [Learn more](https://developer.commerce7.com/docs/app-apis-webhooks)
