...
**Source:** [https://developer.commerce7.com/docs/commerce7-apis](https://developer.commerce7.com/docs/commerce7-apis)

**Section:** api

---
Here's an overview of what you need to know when getting started with our REST APIs and making your first request. If you plan to develop an app, this is a good place to get a basic understanding of how it works before taking a look at the [app development guides](../getting-started/app-development-center.md) .
  * Endpoint
  * Authentication
  * API Requests
  * Pagination
...
> **Do not** place your **App Secret Key** in your javascript as this can be found by other users. Your key must be added through your backend files.
  1. Log into the [App Development Center](https://dev-center.platform.commerce7.com) and select the specific app. (If you don't have an app yet, you'll need to create one first. Learn more [here](../getting-started/creating-an-app.md).)
  ...
  5. The last step is dependant on your app, but if you choose to display your app inside of Commerce7, we also need to authenticate the person using it. You can set this up later as needed, but instructions can be found [here](../app-platform/authenticate-app.md).
