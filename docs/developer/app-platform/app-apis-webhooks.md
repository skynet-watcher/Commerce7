...
**Source:** [https://developer.commerce7.com/docs/app-apis-webhooks](https://developer.commerce7.com/docs/app-apis-webhooks)

**Section:** app platform

---
After you've created your app, it's time to configure your version, most importantly the APIs and webhooks. If you haven't already taken a look through our APIs, you can do so [here](../api/commerce7-apis.md). Once you're familiar with them and ready to configure the APIs needed for your app, you can configure them in your app version.
